...
namespace QuantityMeasurementApp.Models
{
    ...
    public sealed class QuantityLength
    {
        ...
        // <summary>
        // The ConvertTo method converts the current QuantityLength object to a specified target unit. It first converts the current measurement to feet using the ConvertToBase method, and then converts that value to the target unit based on the conversion factors for each unit. This allows for flexible comparisons and conversions between different length units.
        // </summary>
        public QuantityLength ConvertTo(LengthUnit targetUnit)
        {
            double valueInFeet = LengthUnitConverter.ConvertToBase(_value, _unit);
            double convertedValue = LengthUnitConverter.ConvertFromBase(valueInFeet, targetUnit);
        ...
        public QuantityLength Add(QuantityLength other, LengthUnit targetUnit)
        {
            ...
            double sumInFeet = LengthUnitConverter.ConvertToBase(this._value, this._unit) + LengthUnitConverter.ConvertToBase(other._value, other._unit);
            double resultValue = LengthUnitConverter.ConvertFromBase(sumInFeet, targetUnit);
        ...
        public override bool Equals(object? obj)
        {
            ...
            double thisFeet = LengthUnitConverter.ConvertToBase(this._value, this._unit);

            double otherFeet = LengthUnitConverter.ConvertToBase(other._value, other._unit);

            return thisFeet.CompareTo(otherFeet) == 0;
        }
        ...
        {
            double feet = LengthUnitConverter.ConvertToBase(_value, _unit);
