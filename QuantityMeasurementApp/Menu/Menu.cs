...
namespace QuantityMeasurementApp.Menu
{
    public class Menu
    {
        ...
        // <summary>
        // The CompareWeights method prompts the user to enter two weight values and their corresponding units (GRAM/KILOGRAM/POUND), creates QuantityWeight objects for each value, and uses the Equals method of the QuantityWeight class to check if they are equal. It then displays the result to the user.
        // </summary>
        private void CompareWeights()
        {
            ...
            Console.WriteLine("Enter first weight unit (GRAM/KILOGRAM/POUND):");
            WeightUnit unit1 = Enum.Parse<WeightUnit>(Console.ReadLine().ToUpper());

            Console.WriteLine("Enter second weight value:");
            double value2 = double.Parse(Console.ReadLine());

            Console.WriteLine("Enter first weight unit (GRAM/KILOGRAM/POUND):");
            WeightUnit unit2 = Enum.Parse<WeightUnit>(Console.ReadLine().ToUpper());

            var weight1 = new QuantityWeight(value1, unit1);
            var weight2 = new QuantityWeight(value2, unit2);
            System.Console.WriteLine(weight1.Equals(weight2) ? "The weights are equal." : "The weights are not equal.");
        }

        // <summary>
        // The ConvertWeight method prompts the user to enter a weight value, its source unit, and a target unit. It then creates a QuantityWeight object for the input value and uses the ConvertTo method of the QuantityWeight class to convert the weight from the source unit to the target unit. Finally, it displays the converted weight to the user.
        // </summary>
        private void ConvertWeight()
        {
            Console.WriteLine("Enter weight value to convert:");
            double value = double.Parse(Console.ReadLine());

            Console.WriteLine("Enter source weight unit (GRAM/KILOGRAM/POUND):");
            WeightUnit sourceUnit = Enum.Parse<WeightUnit>(Console.ReadLine().ToUpper());

            Console.WriteLine("Enter target weight unit (GRAM/KILOGRAM/POUND):");
            WeightUnit targetUnit = Enum.Parse<WeightUnit>(Console.ReadLine().ToUpper());

            var weight = new QuantityWeight(value, sourceUnit);
            var convertedWeight = weight.ConvertTo(targetUnit);
            Console.WriteLine("Converted weight: " + convertedWeight.Value + " " + convertedWeight.Unit);
        }

        // <summary>
        // The AddWeights method prompts the user to enter two weight values and their corresponding units (GRAM/KILOGRAM/POUND), creates QuantityWeight objects for each value, and uses the Add method of the QuantityWeight class to calculate the sum of the two weights. It then displays the result to the user.
        // </summary>
        private void AddWeights()
        {
            ...
            Console.WriteLine("Enter second weight unit (GRAM/KILOGRAM/POUND):");
            WeightUnit unit2 = Enum.Parse<WeightUnit>(Console.ReadLine().ToUpper());

            var weight1 = new QuantityWeight(value1, unit1);
            var weight2 = new QuantityWeight(value2, unit2);
            var sumWeight = weight1.Add(weight2);
            Console.WriteLine("Sum of the two weights: " + sumWeight.Value + " " + sumWeight.Unit);
        }
    }
}