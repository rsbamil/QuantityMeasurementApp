    ...
    public class Menu
    {
        public void ShowMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("\n--- Temperature ---");
                Console.WriteLine("16. Temperature Equality");
                ...
                switch (choice)
                {
                    ...
                    case 16: TemperatureEquality(); break;
        ...
        // TEMPERATURE
        private Quantity<TemperatureUnit> GetTemperature()
        {
            Console.Write("Enter value: ");
            double value = double.Parse(Console.ReadLine());

            Console.Write("Unit (CELSIUS/FAHRENHEIT/KELVIN): ");
            TemperatureUnit unit =
                Enum.Parse<TemperatureUnit>(Console.ReadLine().ToUpper());
        ...
        {
            var t1 = GetTemperature();
            var t2 = GetTemperature();
        ...
        private void ConvertTemperature()
        {
            ...
            Console.WriteLine(temp.ConvertTo(target));
        }
    }
}